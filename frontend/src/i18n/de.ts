...
profile: {
  ...
  brokerTitle: 'Broker verbinden',
  brokerDesc: 'Verbinde dein externes Broker-Konto, damit deine Bots mit echtem oder Demo-Geld handeln können.',
  alpacaDesc: 'Aktien und ETFs — Paper- und Live-Trading',
  connected: 'Verbunden',
  disconnect: 'Trennen',
  connect: 'Verbinden',
  apiKeyNote: 'Die Schlüssel werden verschlüsselt gespeichert. Sie werden nach dem Speichern nie an den Browser zurückgegeben.',
  apiKey: 'API Key',
...
bots: {
  ...
  modeSimulatedDesc: 'Kein echter Broker',
  modeAlpacaPaper: 'Alpaca Paper',
  modeAlpacaPaperDesc: 'Alpaca Demo',
  modeAlpacaLive: 'Alpaca Live',
  modeAlpacaLiveDesc: '⚠ Echtes Geld',
  alpacaNotConnected: 'Verbinde Alpaca in deinem Profil, um Paper- und Live-Modi zu nutzen.',
  fetchingBalance: 'Kontostand wird abgerufen…',
  buyingPowerAvailable: 'Verfügbare Kaufkraft:',
  stopLossLabel: 'Stop Loss (%)',
  stopLossPlaceholder: 'Z.B. 5 (leer lassen zum Deaktivieren)',
  stopLossDesc: 'Fällt der Preis um diesen % seit dem Einstieg, verkauft der Bot automatisch.',
},
