...
const en: Translations = {
  ...
  verifyEmail: {
    ...
    subtitle: 'One more step for your security',
    desc: 'Email verification protects your account and ensures only you can access your financial analysis.',
    securityFeature: 'Enhanced security',
    securityFeatureDesc: 'Additional protection against unauthorized access',
    instantFeature: 'Instant verification',
    instantFeatureDesc: 'Enter the code we have sent to your email',
    quote: '"An investment in knowledge pays the best interest." — Benjamin Franklin',
    cardTitle: 'Verify your email',
    cardDesc: 'We have sent a 6-digit code to',
    verifying: 'Verifying...',
    verify: 'Verify',
    noCode: "Didn't receive the code?",
    resendIn: 'Resend in {{seconds}}s',
    resendAction: 'Resend code',
    otherEmail: 'Used another email?',
    ...
    verifyError: 'Verification error. Try again.',
  ...
  forgotPwd: {
    ...
    checkEmailDesc: "If an account exists for {{email}}, you'll receive a password reset link in a few moments.",
  },
  resetPwd: {
    ...
    invalidToken: 'The recovery link is invalid or does not contain a token.',
    successTitle: 'Password reset!',
    successDesc: 'Your password has been successfully updated. You will be redirected to login in a few seconds...',
    successButton: 'Go to login now',
    newPassword: 'New password',
    newPasswordDesc: 'Create a secure password for your account',
    newPasswordReqs: 'Requirements: min. 8 characters, one uppercase letter, one number and one symbol',
    confirmPasswordDesc: 'Must match the new password',
    requestNewLink: 'Request new link',
  },
  apiErrors: {
    'El email ya está registrado. Por favor, intente con otro o inicie sesión.': 'Email already registered. Please try another or log in.',
    'El correo proporcionado no coincide con ninguna cuenta existente. Por favor, pruebe con otro correo': 'The provided email is not associated with an existing account. Please try another.',
    'Contraseña incorrecta. Por favor, inténtelo de nuevo.': 'Incorrect password. Please try again.',
    'El código ha expirado. Solicita uno nuevo.': 'The code has expired. Request a new one.',
    'Código incorrecto. Inténtalo de nuevo.': 'Incorrect code. Please try again.',
    'Usuario no encontrado.': 'User not found.',
    'No se pudo enviar el email de verificación. Comprueba que la dirección es correcta.': 'Could not send verification email. Check that the address is correct.',
    ...
    'No se pudo reenviar el email.': 'Could not resend the email.',
    'No hay verificación pendiente para este email.': 'No pending verification for this email.',
    'Token inválido o caducado.': 'Invalid or expired token.',
    'No autenticado. Por favor, inicia sesión.': 'Not authenticated. Please log in.',
  },
