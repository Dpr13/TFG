...
register: {
  ...
  confirmNoMatch: 'Les mots de passe ne correspondent pas',
},

// ── Verify Email ──
  verifyEmail: {
    title: 'Vérifiez votre e-mail',
    subtitle: 'Une étape de plus pour votre sécurité',
    desc: "La vérification par e-mail protège votre compte et garantit que vous seul pouvez accéder à vos analyses financières.",
    securityFeature: 'Sécurité renforcée',
    securityFeatureDesc: 'Protection supplémentaire contre les accès non autorisés',
    instantFeature: 'Vérification instantanée',
    instantFeatureDesc: "Entrez le code que nous avons envoyé à votre e-mail",
    quote: '"An investment in knowledge pays the best interest." — Benjamin Franklin',
    cardTitle: 'Vérifiez votre e-mail',
    cardDesc: 'Nous avons envoyé un code à 6 chiffres à',
    verifying: 'Vérification...',
    verify: 'Vérifier',
    noCode: 'Vous n\'avez pas reçu le code ?',
    resendIn: 'Renvoyer dans {{seconds}}s',
    resendAction: 'Renvoyer le code',
    otherEmail: 'Vous avez utilisé un autre e-mail ?',
    backToRegister: 'Retour à l\'inscription',
    success: 'E-mail vérifié avec succès. Redirection vers la connexion...',
    resendSuccess: 'Code renvoyé. Vérifiez votre boîte de réception.',
    resendError: 'Impossible de renvoyer le code.',
    verifyError: 'Erreur de vérification. Réessayez.',
    digitAriaLabel: 'Chiffre {{index}}',
  },
...
forgotPwd: {
  ...
  checkEmailDesc: "Si un compte existe pour {{email}}, vous recevrez un lien de réinitialisation de mot de passe dans quelques instants.",
},
resetPwd: {
  ...
  invalidToken: 'Le lien de récupération est invalide ou ne contient pas de jeton.',
  successTitle: 'Mot de passe réinitialisé !',
  successDesc: 'Votre mot de passe a été mis à jour avec succès. Vous serez redirigé vers la connexion dans quelques secondes...',
  successButton: 'Aller à la connexion maintenant',
  newPassword: 'Nouveau mot de passe',
  newPasswordDesc: 'Créez un mot de passe sécurisé pour votre compte',
  newPasswordReqs: 'Exigences : min. 8 caractères, un majuscule, un chiffre et un symbole',
  confirmPasswordDesc: 'Doit correspondre au nouveau mot de passe',
  requestNewLink: 'Demander un nouveau lien',
},
apiErrors: {
  'El email ya está registrado. Por favor, intente con otro o inicie sesión.': 'Cet e-mail est déjà enregistré. Veuillez en essayer un autre ou vous connecter.',
  'El correo proporcionado no coincide con ninguna cuenta existente. Por favor, pruebe con otro correo': "L'e-mail fourni n'est associé à aucun compte existant. Veuillez en essayer un autre.",
  'Contraseña incorrecta. Por favor, inténtelo de nuevo.': 'Mot de passe incorrect. Veuillez réessayer.',
  'El código ha expirado. Solicita uno nuevo.': 'Le code a expiré. Demandez-en un nouveau.',
  'Código incorrecto. Inténtalo de nuevo.': 'Code incorrect. Veuillez réessayer.',
  'Usuario no encontrado.': 'Utilisateur non trouvé.',
  'No se pudo enviar el email de verificación. Comprueba que la dirección es correcta.': "Impossible d'envoyer l'e-mail de vérification. Vérifiez que l'adresse est correcte.",
  'Todos los campos son obligatorios.': 'Tous les champs sont obligatoires.',
  'Email y contraseña son obligatorios.': 'L\'e-mail et le mot de passe sont obligatoires.',
  'No se pudo reenviar el email.': "Impossible de renvoyer l'e-mail.",
  'No hay verificación pendiente para este email.': "Aucune vérification en attente pour cet e-mail.",
  'Token inválido o caducado.': 'Jeton invalide ou expiré.',
  'No autenticado. Por favor, inicia sesión.': 'Non authentifié. Veuillez vous connecter.',
},
...
assets: {
  ...
  subtitle: 'Explorez et analysez différents actifs disponibles',
  ...
  search: 'Rechercher',
  noResults: 'Aucun actif trouvé correspondant à votre recherche',
  trySpecific: 'Essayez de rechercher un symbole spécifique (ex. : AAPL, NFLX, META) en appuyant sur Entrée ou le bouton "Rechercher"',
  options: {
    stock: 'Actions',
...
bots: {
  ...
  activeCount: '{n} actif',
  activeCountPlural: '{n} actifs',
  newBot: 'Nouveau Bot',
  infoBanner: 'Les bots opèrent avec des prix simulés générés localement. Chaque tick est généré toutes les 3 secondes avec une variation aléatoire réaliste.',
  noBotsTitle: "Vous n'avez encore aucun bot",
  createPractice: 'Créez-en un pour commencer à pratiquer des stratégies',
  createMyFirst: 'Créer mon premier bot',
  deleteConfirm: 'Supprimer ce bot et tous ses trades ?',
  symbolSearchPlaceholder: 'Rechercher AAPL, BTC-USD, EURUSD=X...',
  typeLabels: { EQUITY: 'Action', CRYPTOCURRENCY: 'Crypto', ETF: 'ETF', CURRENCY: 'Devise', FUTURE: 'Futur', INDEX: 'Indice' },
  modalTitle: 'Nouveau Bot',
  nameLabel: 'Nom',
  namePlaceholder: 'Mon Bot Momentum',
  symbolLabel: 'Symbole',
  symbolHint: 'Prix simulé · sélectionnez un symbole dans la liste',
  useSavedStrategy: 'Utiliser une stratégie sauvegardée',
  noSavedStrategy: '— Sans stratégie sauvegardée —',
  algorithmLabel: 'Algorithme',
  momentumAlgo: 'Momentum (Double Moyenne Mobile)',
  meanReversionAlgo: 'Mean Reversion (Bandes de Bollinger)',
  capitalLabel: 'Capital initial ($)',
  cancelBtn: 'Annuler',
  creating: 'Création…',
  createBtn: 'Créer le Bot',
  nameRequired: 'Le nom est obligatoire',
  symbolRequired: 'Sélectionnez un symbole valide dans la liste',
  createError: 'Erreur lors de la création du bot',
  loading: 'Chargement…',
  ...
  noTrades: "Aucun trade pour l'instant. Démarrez le bot pour commencer.",
  colSide: 'Côté',
